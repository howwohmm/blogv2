...
categories: ["leadership", "simon-sinek", "business", "purpose", "notes"]
summary: "Detailed notes and analysis from Simon Sinek's talk about finding your 'why' - the core belief that drives everything you do, not just what you do."
---
